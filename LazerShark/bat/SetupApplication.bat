...
:: Android packaging
set AND_CERT_NAME="LazerShark"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\LazerShark.p12
...
set IOS_PROVISION=cert\LazerShark.mobileprovision
...
set APP_ID=air.LazerShark

:: Output packages
set DIST_PATH=dist
set DIST_NAME=LazerShark
